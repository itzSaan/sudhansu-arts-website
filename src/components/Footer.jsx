...
const Footer = () => {
  return (
    <footer>
      <div className="top-footer bg-grey">
        <div className="px-4 sm:px-6 lg:px-8 max-w-7xl container py-8 mx-auto">
          <div className="flex items-center justify-between py-6">
            <h2 className="text-3xl md:text-4xl font-bold font-boldonse">
              Let's <span className="text-red">Connect</span> there
            </h2>
            <a
              href="/contact"
              className="p-2 md:py-2 text-sm md:text-normal md:px-5 bg-red text-white rounded-0 font-semibold"
            >
              Contact Us
            </a>
          </div>

          <div className="my-4 border-b border-b-red/10"></div>

          <div className="flex flex-wrap gap-5 justify-between py-6">
            <div className="max-w-full md:max-w-74">
              ...
              <p className="my-5 text-sm">
                ...
                Excepturi exercitationem veritatis vitae eveniet, deserunt id?
              </p>
            ...
            <div className="footer-Contact">
              ...
              <ul className="flex flex-col gap-3 text-sm">
                <li>+91 9778457485</li>
                <li>sudhansuartspdp@gmail.com</li>
                <li>GIC-101, Paradip, <br /> Odisha, India-754142</li>
              </ul>
            </div>

            <div className="footer-subscribe max-w-74">
            <h6 className="text-lg font-semibold mb-3">Get the latest information</h6>
            <form action="" className="flex pt-3">
              <input type="email" required placeholder="Email address" className="px-4 py-3 bg-red/10"/>
              <button type="submit" className="px-3 py-2 bg-red">
                Go
              </button>
            </form>
            </div>
      ...
      {/* bottom footer */}
      <div className="bottom-footer bg-red">
        <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto container py-3 md:py-4 flex flex-col text-sm md:flex-row md:text-md items-center justify-between">
          <p>Copyright © 2025 Sudhansu Arts. All Rights Reserved.</p>
          <p>
            <a href="">User Term & Conditions</a>
            &nbsp; | &nbsp;
